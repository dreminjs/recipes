import { AdminPostCharacteristic, AdminPostIngredientForm } from 'apps/client/src/features/admin';
import {
  BasicModal,
...
export const AdminPostIngredientModal: FC<IProps> = ({ onPost, onToggleVisibility,isOpen }) => {
  return (
